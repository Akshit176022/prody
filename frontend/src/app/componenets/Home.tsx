  ...
  return (
    <div className="relative flex justify-center  text-white text-2xl ml-16 mt-10 font-bold w-[100vw] h-[150vh]" style={{ gridRow: "span 2" }}>
      ...
      <div className=" flex items-end">
        ...
        <div className=" absolute top-80 right-20 -translate-x-7 hover:bg-transparent w-56 h-16 flex items-center justify-center rounded-2xl border-[1px] border-white p-2 text-white text-[24px] hover:bg-teal-400 hover:scale-105 transition-transform duration-300 shadow-lg text-center">
